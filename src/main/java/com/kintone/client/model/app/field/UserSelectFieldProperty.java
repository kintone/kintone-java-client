...
/**
 * An object containing the properties of a User Selection field for getting and setting the field
 * settings.
 */
@Data
@JsonIgnoreProperties(value = "type", allowGetters = true)
public class UserSelectFieldProperty implements FieldProperty {
