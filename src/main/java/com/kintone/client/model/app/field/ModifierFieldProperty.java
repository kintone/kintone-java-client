...
/**
 * An object containing the properties of the Modifier field for getting and setting the field
 * settings.
 */
@Data
@JsonIgnoreProperties(value = "type", allowGetters = true)
public class ModifierFieldProperty implements FieldProperty {
