...
/**
* An object containing the properties of the Record number field for getting and setting the field
* settings.
*/
@Data
@JsonIgnoreProperties(value = "type", allowGetters = true)
public class RecordNumberFieldProperty implements FieldProperty {
